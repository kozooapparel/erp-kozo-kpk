...
export default function AddOrderModal({ isOpen, onClose, customers }: AddOrderModalProps) {
    ...
    return (
        <div className="fixed inset-0 z-50 flex items-center justify-center">
            ...
            {/* Modal */}
            <div className="relative w-full max-w-lg max-h-[90vh] overflow-y-auto bg-slate-800 rounded-2xl border border-slate-700 shadow-2xl m-4">
                {/* Header */}
                <div className="sticky top-0 bg-slate-800 px-6 py-4 border-b border-slate-700 flex items-center justify-between">
                    <h2 className="text-xl font-bold text-white">Tambah Order Baru</h2>
                    <button
                        onClick={onClose}
                ...
                <form onSubmit={handleSubmit} className="p-6 space-y-5">
                        ...
                        {!showNewCustomer ? (
                            <div className="space-y-2">
                                <select
                                    ...
                                    className="w-full px-4 py-3 rounded-xl bg-slate-900/50 border border-slate-600/50 text-white focus:outline-none focus:ring-2 focus:ring-emerald-500/50"
                                >
                            ...
                            <div className="space-y-3 p-4 rounded-xl bg-slate-900/50 border border-slate-600/50">
                                <input
                                    type="text"
                                    ...
                                    required={showNewCustomer}
                                    className="w-full px-4 py-2 rounded-lg bg-slate-800 border border-slate-600/50 text-white focus:outline-none focus:ring-2 focus:ring-emerald-500/50"
                                />
                                <input
                                    type="tel"
                    ...
                    <div>
                        ...
                        <textarea
                            ...
                            rows={3}
                            className="w-full px-4 py-3 rounded-xl bg-slate-900/50 border border-slate-600/50 text-white focus:outline-none focus:ring-2 focus:ring-emerald-500/50 resize-none"
                        />
                    </div>
                    ...
                    <div>
                        ...
                        <div className="relative">
                            {mockupPreview ? (
                                ...
                                <label className="flex flex-col items-center justify-center w-full h-32 rounded-xl border-2 border-dashed border-slate-600 hover:border-emerald-500/50 bg-slate-900/50 cursor-pointer transition-colors">
